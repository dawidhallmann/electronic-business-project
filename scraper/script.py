...
print('Znaleziono '+str(len(products_links))+' unikatowych produktów.')
print('Znaleziono '+str(len(products_links_done))+' pobranych produktów.')
...
for pd_link in products_links:
    if (not any(x for x in products_links_done if x == pd_link)):
        ...
        print('Progress '+str(len(products_links_done))+'/'+str(len(products_links)))
